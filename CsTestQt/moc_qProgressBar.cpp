...
QT_MOC_LITERAL(1, 12, 12), // "s_SetMaximum"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 3), // "Max"
QT_MOC_LITERAL(4, 30, 12), // "s_SetCurrent"
QT_MOC_LITERAL(5, 43, 7) // "CurrVal"

    },
    "progressBar\0s_SetMaximum\0\0Max\0"
    "s_SetCurrent\0CurrVal"
};
...
void progressBar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->s_SetMaximum((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->s_SetCurrent((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    }
}
